      ...
      <div className="md:w-11/12">
        <div className="flex flex-col md:flex-row gap-8 md:gap-24 my-8 md:my-0">
          <div className="md:w-4/12 md:relative bottom-20">
            <h1 className="text-4xl text-center md:text-start">START PLAYING.</h1>
            <h1 className="text-4xl text-center md:text-start">START WINNING.</h1>
          </div>
        ...
        <div className="w-full flex flex-col justify-center md:flex-row md:justify-between">
          ...
          <h1 className="font-inter md:text-start text-center">Mini-ICP 2024, All rights reserved.</h1>
        </div>
      </div>
    </div>
  );
