import Image from "../../assets/img13.png";
...
const Hero = () => {
  return (
    <div className="w-full md:flex flex-col lg:flex-row justify-center">
      <div className="w-full max-w-screen-md flex justify-center mt-16">
        <motion.img
      ...
      <div className="lg:absolute flex justify-center my-2 md:my-0 left-14 bottom-[26rem]">
        <motion.div
      ...
      <div className="lg:absolute flex justify-center left-14 bottom-[11rem] overflow-y-hidden max-h-56">
        <motion.div
